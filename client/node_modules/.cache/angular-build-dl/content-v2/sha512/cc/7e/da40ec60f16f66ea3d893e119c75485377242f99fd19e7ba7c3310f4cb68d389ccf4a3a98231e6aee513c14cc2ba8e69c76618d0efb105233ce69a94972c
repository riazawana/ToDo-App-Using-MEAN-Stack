...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<app-notes></app-notes>";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppNotesNotesComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "\n\n      <select (change)=\"onChange($event)\" class=\"position-absolute ml-3 float-left\"> \n       <option value=\"all\" selected>All</option>\n       <option value=\"completed\">Completed</option>\n       <option value=\"pending\">Pending</option>\n     </select>\n\n<div class=\"container\">\n    <form #myForm='ngForm'>\n    <div class=\"input-group mb-2 col-6 mx-auto mt-4\">\n        <input type=\"text\" class=\"form-control\" placeholder=\"Enter Task to be Assign\" name=\"todoText\" #todoText=\"ngModel\" [(ngModel)]=\"todoApp.todoText\" required>\n        <div class=\"input-group-append\">\n          <button [disabled]=\"todoText.invalid\" class=\"btn btn-primary\" (click)=\"addTodo(myForm)\" type=\"button\" id=\"button-addon2\">Add</button>\n        </div>\n      </div>\n    </form>\n      <div *ngIf=\"todoText.invalid && (todoText.dirty || todoText.touched)\" class=\"text-danger col-6 mx-auto\">\n        <div *ngIf=\"todoText.errors.required\">\n          Todo is required\n        </div>\n      </div>\n   \n      <div class=\"col-6 mx-auto\" *ngFor=\"let note of todoArr\">\n        <div class=\"alert alert-primary\" role=\"alert\" >\n            <div class=\"row\">\n               <div class=\"col-6\">\n                <label>{{note.text}}</label>\n               </div> \n               <div class=\"col-6\">\n                   <button *ngIf=\"note.status=='pending'\" (click)=\"updateTodo(note)\" class=\"btn btn-success mr-2\">Mark Completed</button> \n                   <button *ngIf=\"note.status=='completed'\" class=\"btn btn-success disabled mr-2\">Completed</button> \n                   <button class=\"btn btn-danger\" (click)=\"deleteTodo(note)\">Delete</button>\n               </div>\n            </div>\n            \n        </div>\n      </div>\n\n</div>";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _notes_notes_component__WEBPACK_IMPORTED_MODULE_9__["NotesComponent"]],
  ...
  function srcAppNotesNotesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var NotesComponent = /*#__PURE__*/function () {
      function NotesComponent(todoService, toastr) {
      ...
      _createClass(NotesComponent, [{
        ...
        value: function getTodoList() {
          ...
          this.todoService.getAllTodos().subscribe(function (res) {
            _this.todoArr = res['data'];
            _this.filterArr = res['data'];
        ...
        value: function addTodo(data) {
          ...
          var todo = data.form.value.todoText;
          console.log("Data", data.form.value);
          var todoDetails = {
            text: todo
          };
          this.todoService.addTodo(todoDetails).subscribe(function (res) {
        ...
        key: "deleteTodo",
        value: function deleteTodo(mf) {
          var _this3 = this;

          var todoDetails = {
            todoId: mf._id
          };
          this.todoService.deleteTodo(todoDetails).subscribe(function (res) {
        ...
        value: function updateTodo(not) {
          ...
          this.todoService.updateTodo(todoDetails).subscribe(function (res) {
        ...
        value: function onChange(event) {
          ...
          if (key == 'pending') {
            this.todoArr = this.filterArr.filter(function (item) {
    ...
    NotesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      providers: [_services_todo_service__WEBPACK_IMPORTED_MODULE_2__["TodoService"]],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./notes.component.css */
    ...
    var TodoService = /*#__PURE__*/function () {
      ...
      _createClass(TodoService, [{
        ...
        value: function getAllTodos() {
          return this.http.get("".concat(this.baseUrl, "getAll"));
        }
      }, {
        key: "addTodo",
        value: function addTodo(todoDetails) {
          return this.http.post("".concat(this.baseUrl, "addTodo"), todoDetails);
        }
      }, {
        key: "deleteTodo",
        value: function deleteTodo(todoDetails) {
          return this.http.post("".concat(this.baseUrl, "deleteTodo"), todoDetails);
        }
      }, {
        key: "updateTodo",
        value: function updateTodo(todoDetails) {
          return this.http.post("".concat(this.baseUrl, "updateTodo"), todoDetails);
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/riaz/Documents/todo-appAssignment/client/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
